...
router_database_doctors = APIRouter()

@router_database_doctors.get("/doctors_by_location") #not implemented
...
@router_database_doctors.get("/doctors_by_price") #not implemented
...
@router_database_doctors.get("/doctors_by_availability") #not implemented
